...
class AcceptanceLeaf {
  ...
  constructor(vault: AcceptanceVault, private readonly opens: string[], buffers: Map<string, string>) {
...
class AcceptanceWorkspace extends FakeWorkspace {
  ...
  constructor(private readonly vault: AcceptanceVault, private readonly buffers: Map<string, string>) {
    super();
    this.leaves = [new AcceptanceLeaf(vault, this.opens, buffers)];
  }
  ...
  getLeaf(mode: boolean | string): AcceptanceLeaf {
    ...
    const leaf = new AcceptanceLeaf(this.vault, this.opens, this.buffers);
...
export class ProductionAcceptanceHost {
  ...
  readonly workspace = new AcceptanceWorkspace(this.vault, this.buffers);
